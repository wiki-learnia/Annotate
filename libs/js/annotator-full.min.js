...
**
** Built at: 2014-06-01 11:32:04Z
*/


(function() {
  var $, Annotator, Delegator, LinkParser, Range, base64Decode, base64UrlDecode, createDateFromISO8601, findChild, fn, functions, g, getNodeName, getNodePosition, gettext, parseToken, simpleXPathJQuery, simpleXPathPure, util, _Annotator, _gettext, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _t,
    __slice = [].slice,
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.annotationReferences = {};
    ...
    function Annotator(element, options) {
      ...
      this.loadAnnotationsByUID = __bind(this.loadAnnotationsByUID, this);
      this.removeDOMAnnotationsByUID = __bind(this.removeDOMAnnotationsByUID, this);
      this.removeDOMAnnotations = __bind(this.removeDOMAnnotations, this);      Annotator.__super__.constructor.apply(this, arguments);
      this.plugins = {};
    ...
    Annotator.prototype.setupAnnotation = function(annotation, color, id) {
      var e, highlightsOld, normed, normedRanges, quoteOld, r, rangesOld, root, _k, _l, _len2, _len3, _len4, _m, _ref1;
      ...
      quoteOld = annotation.quote;
      rangesOld = annotation.ranges;
      highlightsOld = annotation.highlights;
      normedRanges = [];
      ...
      if (quoteOld === annotation.quote && id === 'user' && annotation.quote.length) {
        if (annotation.revision_id !== wgCurRevisionId) {
          console.log('Revision IDs does not match but we got the right annotation' + annotation.revision_id + '' + annotation.quote);
          console.log('cur rev' + wgCurRevisionId);
          annotation.revision_id = wgCurRevisionId;
          annotation.ranges = rangesOld;
          this.updateAnnotation(annotation);
        }
      }
      if (quoteOld !== annotation.quote && annotation.quote.length && quoteOld && id === 'user') {
        annotation.quote = quoteOld;
        annotation.ranges = rangesOld;
        annotation.highlights = highlightsOld;
        window.annos[annotation.id] = annotation;
        console.log('Some not matching annotation');
        return annotation;
      }
      console.log(id);
      for (_m = 0, _len4 = normedRanges.length; _m < _len4; _m++) {
        normed = normedRanges[_m];
        annotation.ranges.push(normed.serialize(this.wrapper[0], '.annotator-hl'));
        $.merge(annotation.highlights, this.highlightRange(normed, 'annotator-hl', color));
      }
    ...
    Annotator.prototype.removeDOMAnnotation = function(annotation) {
      var child, h, _k, _len2, _ref1;
    ...
    Annotator.prototype.removeDOMAnnotations = function(annotations) {
      var an, _k, _len2, _results;
      ...
      for (_k = 0, _len2 = annotations.length; _k < _len2; _k++) {
        an = annotations[_k];
        _results.push(this.removeDOMAnnotation(an));
      }
      return _results;
    };

    Annotator.prototype.removeDOMAnnotationsByUID = function(id) {
      return this.removeDOMAnnotations(this.annotationReferences[id]);
    };

    Annotator.prototype.loadAnnotations = function(annotations, id, color) {
      var clone, loader,
        _this = this;
      ...
      loader = function(annList, id, color) {
        var n, now, _k, _len2;
        ...
        _this.annotationReferences[id] = [];
        for (_k = 0, _len2 = now.length; _k < _len2; _k++) {
          n = now[_k];
          _this.annotationReferences[id].push(_this.setupAnnotation(n, color, id));
        }
        if (annList.length > 0) {
          ...
          return window.updateWrongAnnoList();
        }
      };
      clone = annotations.slice();
      if (annotations.length) {
        loader(annotations, id, color);
      }
      return this;
    };

    Annotator.prototype.loadAnnotationsByUID = function(id, color) {
      var an;

      an = this.plugins['Store'].annotationsByFriends[id].slice();
      return this.loadAnnotations(an, id, color);
    };
    ...
    Annotator.prototype.highlightRange = function(normedRange, cssClass, color) {
      ...
      white = /^\s*$/;
      hl = $("<span style='background:" + color + ";' class='" + cssClass + "'></span>");
    ...
    Annotator.prototype.highlightRanges = function(normedRanges, cssClass, color) {
      ...
      for (_k = 0, _len2 = normedRanges.length; _k < _len2; _k++) {
        r = normedRanges[_k];
        $.merge(highlights, this.highlightRange(r, cssClass, color));
      }
      return highlights;
    };
    ...
    Annotator.prototype.addPlugin = function(name, options) {
      ...
      if (typeof klass === 'function') {
        ...
        return typeof (_base = this.plugins[name]).pluginInit === "function" ? _base.pluginInit() : void 0;
      } else {
        return console.error(_t("Could not load ") + name + _t(" plugin. Have you included the appropriate <script> tag?"));
      }
    };
  ...
  Annotator.Viewer = (function(_super) {
    ...
    Viewer.prototype.load = function(annotations) {
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        ...
        if (this.options.readOnly || annotation.highlights[0].style['background-color'] || annotation.user_id !== 'user') {
          edit.remove();
          del.remove();
        } else {
          controller = {
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype.annotationUpdated = function(annotation) {
      ...
      if (__indexOf.call(this.annotations, annotation) >= 0) {
        return this._apiRequest('update', annotation, (function(datas) {
          return _this.updateAnnotation(annotation, datas['annotateapi']['annotations']);
        }));
      }
    };
    ...
    Store.prototype._onLoadAnnotations = function(datas) {
      var a, annotation, annotationMap, data, newData, _k, _l, _len2, _len3, _ref3;
      ...
      data = datas['annotateapi']['annotations']['user'];
      this.annotationsByFriends = datas['annotateapi']['annotations'];
      newData = [];
  ...
  Annotator.Plugin.AnnotateItPermissions = (function(_super) {
    ...
    function AnnotateItPermissions() {
      ...
      this.updateAnnotationPermissions = __bind(this.updateAnnotationPermissions, this);
      this.updatePermissionsField = __bind(this.updatePermissionsField, this);
      this.addFieldsToAnnotation = __bind(this.addFieldsToAnnotation, this);      _ref3 = AnnotateItPermissions.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  Annotator.Plugin.Tags = (function(_super) {
    ...
    function Tags() {
      ...
      this.updateField = __bind(this.updateField, this);      _ref4 = Tags.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
